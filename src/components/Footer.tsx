      ...
      <div className="section-container relative z-10 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Prakasham. All rights reserved.
          </p>
          
          <div className="mt-4 md:mt-0 flex items-center">
            <a href="mailto:info@prakasham.app" className="text-sm flex items-center text-muted-foreground hover:text-foreground transition-colors">
              <Mail size={16} className="mr-2" />
              <span>info@prakasham.app</span>
            </a>
          </div>
        </div>
      </div>
